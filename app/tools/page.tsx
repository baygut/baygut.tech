          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-tools-muted/90 text-lg leading-relaxed mix-blend-plus-lighter">
                A personal hub of single-file interactive deployments, utility scripts, and isolated UX experiments. Everything here runs sandboxed in the browser.
              </p>
            </div>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="transition-transform duration-300 group-hover:rotate-90">
