    ...
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-10 pb-6 border-b border-tools-border/40">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-white font-medium text-lg">
              {tools?.length || 0} Tools Deployments
            </div>
        ...
        <div className="relative w-full sm:w-80 group">
          <Search
            size={16}
            className="absolute left-3.5 top-1/2 -translate-y-1/2 text-tools-muted group-focus-within:text-tools-accent transition-colors"
          />
          <input
            type="text"
                ...
                >
                  ...
                  <div className="p-7 flex-1 relative flex flex-col">
                          ...
                          <div className={`relative flex items-center justify-center w-2 h-2`}>
                            ...
                            <div
                              className={`w-2 h-2 rounded-full relative z-10 ${
                                recent
                                  ? 'bg-[#a3e635] shadow-[0_0_8px_rgba(163,230,53,0.8)]'
                                  : 'bg-[#6b7280]'
                              }`}
                            />
                          </div>
                    ...
                    <p className="text-tools-muted text-[15px] leading-relaxed mb-6 line-clamp-3 font-medium">
                      {tool.description || (
                        <span className="italic opacity-50">No description documented.</span>
                      )}
                    </p>
